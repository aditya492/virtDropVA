...
class FourthPage extends Component {
  ...
  render() {
    ...
    const rateObj = [
      { top: "Standard", rate: "12", includes: standard,head:"Mid Level Tasks" },
      { top: "Gold", rate: "15", includes: gold,head:"Entry Level Tasks" },
      { top: "Premium", rate: "20", includes: premium,head:"Expert Level Tasks" },
    ];

    return (
      <>
        <div className="Multistep_container va_page4">
          <h2 class="heading mt_30 ">Choose Your Plan?</h2>
          <div class="select_plans mt_30 rowsPrice">
            {rateObj.map((item, id) => {
              return (
                <>
